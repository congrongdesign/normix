...
```text
Normix-1.0.5-mac-arm64.dmg
```

直接下载：[Normix-1.0.5-mac-arm64.dmg](https://github.com/congrongdesign/normix/releases/latest/download/Normix-1.0.5-mac-arm64.dmg)

Intel Mac 用户下载：

```text
Normix-1.0.5-mac-x64.dmg
```

直接下载：[Normix-1.0.5-mac-x64.dmg](https://github.com/congrongdesign/normix/releases/latest/download/Normix-1.0.5-mac-x64.dmg)
...
```text
Normix-1.0.5-win-x64-setup.exe
```

直接下载：[Normix-1.0.5-win-x64-setup.exe](https://github.com/congrongdesign/normix/releases/latest/download/Normix-1.0.5-win-x64-setup.exe)

或下载免安装便携版：

```text
Normix-1.0.5-win-x64-portable.exe
```

直接下载：[Normix-1.0.5-win-x64-portable.exe](https://github.com/congrongdesign/normix/releases/latest/download/Normix-1.0.5-win-x64-portable.exe)

如果出现 SmartScreen 提示，请选择“更多信息 > 仍要运行”。安装版支持自定义安装目录，并可创建桌面和开始菜单快捷方式。

如果旧版 Windows 安装包启动时提示 `Could not load the "sharp" module`，请重新下载当前 `v1.0.5` 安装包，新版已包含 Windows 原生模块。
